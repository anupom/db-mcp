...
export default function DatabasesPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm(`Are you sure you want to delete database "${id}"?`)) {
      return;
    }
    ...
    <div className="p-6">
                  ...
                  <tr key={db.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{db.id}</div>
                        {db.description && (
                      ...
                      <div className="flex items-center justify-end gap-2">
                        {isLoading ? (
                          ...
                          <>
                            ...
                            {db.id !== 'default' && db.status !== 'active' && (
                              <button
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        ...
        <p className="text-sm text-blue-700">
          Each active database gets its own MCP endpoint at <code className="bg-blue-100 px-1 rounded">/mcp/:databaseId</code>.
